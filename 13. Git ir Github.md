...
##### 1. Sukurkite `index.html` failą savo repozitorijoje arba naudokite jau esamą repozitoriją

##### 2. Patalpinkite svetainę naudojant GitHub Pages

-   Eikite į savo repozitoriją GitHub.
-   Paspauskite "Settings" ir suraskite "Pages" sekciją.
-   Pasirinkite šaką (pvz., `main` arba `master`) ir paspauskite "Save".[![image.png](https://i.postimg.cc/BvNCX87S/image.png)](https://postimg.cc/DWJGNzKH)
-   Jūsų svetainė bus pasiekiama per URL: `https://username.github.io/repository`.

> Pvz. https://rokasandreikenas.github.io/future-web
> arba https://rokasandreikenas.com/future-web/


Jei norite sukurti svetainę, kuri bus pasiekiama per URL `https://username.github.io` be papildomos repozitorijos pavadinimo, sukurkite repozitoriją pavadinimu `username.github.io` (pakeičiant "username" į savo GitHub vartotojo vardą). Tai leis talpinti pagrindinę svetainę tiesiai jūsų GitHub vartotojo puslapyje. 

> Pvz.: https://github.com/rokasandreikenas/rokasandreikenas.github.io

Jeigu norite naudoti savo custom domain, turite sekti pagal atskirą tutorialą. https://www.youtube.com/watch?v=rIXWUJ5U8bY

Nusipirkus domeną ir jį sukonfiguravus galite gauti tokį rezultatą [https://rokasandreikenas.com](https://rokasandreikenas.com/)
...
#### Užduotis 4: Sukurkite GitHub Pages svetainę

1.  Patalpinkite `index.html` failą savo GitHub repozitorijoje `my-first-repo`.
2.  Eikite į savo repozitorijos "Settings" ir suraskite "Pages" sekciją.
3.  Pasirinkite šaką `main` arba `master` ir paspauskite "Save".
4.  Patikrinkite savo GitHub Pages svetainę per URL: `https://username.github.io/my-first-repo`.

#### Užduotis 5: Sukurkite vartotojo svetainę GitHub Pages

1.  Sukurkite naują viešą repozitoriją pavadinimu `username.github.io` (pakeičiant "username" į savo GitHub vartotojo vardą).
2.  Inicializuokite naują Git repozitoriją savo kompiuteryje ir sujunkite ją su GitHub repozitorija.
...
5.  Patikrinkite savo GitHub vartotojo svetainę per URL: `https://username.github.io`.
